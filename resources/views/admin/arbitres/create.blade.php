        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="name" class="w-full px-4 py-2.5 rounded-lg border border-slate-200 outline-none focus:ring-2 focus:ring-[#1B6B3A]">
                </div>
                <div>
                    <label class="block text-sm font-bold text-slate-700 mb-1">Email</label>
                    <input type="email" name="email" class="w-full px-4 py-2.5 rounded-lg border border-slate-200 outline-none focus:ring-2 focus:ring-[#1B6B3A]">
                </div>
                <div>
                    <label class="block text-sm font-bold text-slate-700 mb-1">Mot de passe provisoire</label>
                    <input type="password" name="password" class="w-full px-4 py-2.5 rounded-lg border border-slate-200 outline-none focus:ring-2 focus:ring-[#1B6B3A]">
                </div>
            </div>
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="telephone" class="w-full px-4 py-2.5 rounded-lg border border-slate-200 outline-none focus:ring-2 focus:ring-[#1B6B3A]">
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="text" name="adresse" class="w-full px-4 py-2.5 rounded-lg border border-slate-200 outline-none focus:ring-2 focus:ring-[#1B6B3A]">
                </div>
            </div>
        </div>

        <div class="flex gap-4">
            <button type="submit" class="bg-[#1B6B3A] text-white px-8 py-3 rounded-lg font-bold hover:shadow-lg transition-all">Enregistrer l'arbitre</button>
